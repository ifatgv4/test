...
#! @input tenant_name: name of OpenStack project that contains server (instance) to be started
#! @input server_id: ID of server (instance) to be started
...
#! @result SUCCESS: OpenStack server (instance) was successfully started
...
#!                                step response
#! @result START_SERVER_FAILURE: OpenStack server (instance) cannot be started
#!!#
####################################################
