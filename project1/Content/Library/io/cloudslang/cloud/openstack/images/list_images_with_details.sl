...
####################################################
#!!
#! @description: Retrieves a list of OpenStack images with all details.
...
#! @result SUCCESS: list with images details were successfully retrieved
...
#! @result LIST_IMAGES_WITH_DETAILS_FAILURE: list with images details could not be retrieved
#!!#
####################################################
  ...
  workflow:
    - authentication:
        ...
        publish:
          ...
          - error_message
        navigate:
          - SUCCESS: list_images_with_details
    ...
    - list_images_with_details:
        do:
          rest.http_client_get:
            - url: ${'http://'+ host + ':' + compute_port + '/v2/' + tenant_id + '/images/detail'}
            - proxy_host
            - proxy_port
            - proxy_username
            - proxy_password
        ...
        navigate:
          - SUCCESS: SUCCESS
          - FAILURE: LIST_IMAGES_WITH_DETAILS_FAILURE
