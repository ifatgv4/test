...
####################################################
#!!
#! @description: Performs a REST API call to reload an embedded cartridge configuration if it has been modified.
...
#! @input cartridge: name of the framework to be reloaded
