...
####################################################
#!!
#! @description: Performs a REST API call to start an existing RedHat OpenShift Online application.
...
#! @input application_name: RedHat OpenShift Online application name that will be started
